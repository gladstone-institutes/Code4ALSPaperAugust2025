...
input_path <- '/Users/nalbistami/Gladstone Dropbox/Noura Al Bistami/AALS Shared DropBox/GEDI Analysis/Combined Experiments/CombinedC9orf72/Cell line compare (manuscript)'
output_path <- '/Users/nalbistami/Gladstone Dropbox/Noura Al Bistami/AALS Shared DropBox/GEDI Analysis/Combined Experiments/CombinedC9orf72/Cell line compare (manuscript)'
...
keep_drug <- c("None")
keep_line <- c("0YX7iCTR", "2AE8iCTR", "BUUiALS","6ZLDiALS")
keep_line_drug <- ""
...
mrid_lmer_condition_comparisons(logodd_data, ref_condition_list, output_path, 
                                ...
                                multiple_experiments, multiple_plates, classes)
